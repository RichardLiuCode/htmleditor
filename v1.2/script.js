...
function importFromGithub() {
    if (document.getElementById("input").value != "") {
        var ifTheUserSureToImportFromGithub = confirm("Import a project will replace all your work here! Do you want to continue?")
